...
import * as styles from "./WorkPage.module.less";

const WorkPage = () => {
  return (
    <MainLayout
      title="Evgeny Mironenko | Working Experience"
